...
public class QuestionUtil {
    ...
    public static boolean isContent(String paragraph) {
        List<String> patterns = new ArrayList<String>();
        patterns.add("\\s*[0-9一二三四五六七八九十❶❷❸❹❺❻❼❽❾❿①②③④⑤⑥⑦⑧⑨⑩]\\s*[．\\.、]+\\s*\\d+\\s*[．\\.、]+(.|\\s)*");
        ...
        patterns.add("\\s*例\\s*[0-9一二三四五六七八九十❶❷❸❹❺❻❼❽❾❿①②③④⑤⑥⑦⑧⑨⑩]?\\s*题\\s*[．\\.、：:]*(.|\\s)*");
        patterns.add("\\s*[【\\[（\\(]\\s*例\\s*[0-9一二三四五六七八九十❶❷❸❹❺❻❼❽❾❿①②③④⑤⑥⑦⑧⑨⑩]?\\s*题\\s*[】\\]）\\)](.|\\s)*");
        ...
        patterns.add("\\s*实\\s*践\\s*应\\s*用\\s*[0-9一二三四五六七八九十❶❷❸❹❺❻❼❽❾❿①②③④⑤⑥⑦⑧⑨⑩]?\\s*[．\\.、：:]*(.|\\s)*");
        patterns.add("\\s*[【\\[（\\(]\\s*实\\s*践\\s*应\\s*用\\s*[0-9一二三四五六七八九十❶❷❸❹❺❻❼❽❾❿①②③④⑤⑥⑦⑧⑨⑩]?\\s*[】\\]）\\)](.|\\s)*");
        patterns.add("\\s*再\\s*探\\s*新\\s*知\\s*[0-9一二三四五六七八九十❶❷❸❹❺❻❼❽❾❿①②③④⑤⑥⑦⑧⑨⑩]?\\s*[．\\.、：:]*(.|\\s)*");
        patterns.add("\\s*[【\\[（\\(]\\s*再\\s*探\\s*新\\s*知\\s*[0-9一二三四五六七八九十❶❷❸❹❺❻❼❽❾❿①②③④⑤⑥⑦⑧⑨⑩]?\\s*[】\\]）\\)](.|\\s)*");
        patterns.add("\\s*学\\s*以\\s*致\\s*用\\s*[0-9一二三四五六七八九十❶❷❸❹❺❻❼❽❾❿①②③④⑤⑥⑦⑧⑨⑩]?\\s*[．\\.、：:]*(.|\\s)*");
        patterns.add("\\s*[【\\[（\\(]\\s*学\\s*以\\s*致\\s*用\\s*[0-9一二三四五六七八九十❶❷❸❹❺❻❼❽❾❿①②③④⑤⑥⑦⑧⑨⑩]?\\s*[】\\]）\\)](.|\\s)*");
        String pattern = "^(" + StringUtils.join(patterns, "|") + ")$";
